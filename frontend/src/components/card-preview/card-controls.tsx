...
import { Square, RectangleVertical, Smartphone, RectangleHorizontal, Image, Type, User, Sparkles, ArrowUp, ArrowDown, Crown } from "lucide-react";
import type { CardTheme, CardFormat, CardFontSize } from "@/types/card";
    ...
    <div className="space-y-6">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isSelected ? "ring-primary scale-105" : "ring-transparent hover:ring-muted-foreground/50"
                )}
                title={name}
              >
                <div
      ...
      <div className="space-y-3">
        ...
        <div className="flex rounded-lg overflow-hidden border-2 border-muted">
          {(["small", "medium", "large"] as CardFontSize[]).map((size) => {
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            { id: "artwork", icon: Image, label: "Pochette", checked: showArtwork, onChange: setShowArtwork },
            { id: "title", icon: Type, label: "Titre", checked: showTitle, onChange: setShowTitle },
            { id: "artist", icon: User, label: "Artiste", checked: showArtist, onChange: setShowArtist },
